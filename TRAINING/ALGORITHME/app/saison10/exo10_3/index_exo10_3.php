...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison10/exo10_3/season10_exo_3.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 10.3</h5>
              <p class="card-text">On travaille avec le fichier du carnet d’adresses en champs de largeur fixe.<br>
