...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison7/exo7_6/season7_exo_6.js"></script>
    </head>
  <body>
      <!-- NAVBAR -->
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 7.6</h5>
              <p class="card-text">Ecrire un algorithme qui calcule le plus grand écart dans un tableau de X entiers positifs, comme négatifs.
              <div style="display: flex; justify-content: center;">
