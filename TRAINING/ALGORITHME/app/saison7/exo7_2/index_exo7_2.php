...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison7/exo7_2/season7_exo_2.js"></script>
    </head>
  <body>
      <!-- NAVBAR -->
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 7.2</h5>
              <p class="card-text">Ecrivez un algorithme qui trie un tableau dans l’ordre décroissant.<br>
