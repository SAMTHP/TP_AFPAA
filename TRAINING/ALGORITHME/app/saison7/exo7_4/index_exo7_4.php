...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison7/exo7_4/season7_exo_4.js"></script>
    </head>
  <body>
      <!-- NAVBAR -->
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 7.4</h5>
              <p class="card-text">Ecrivez un algorithme qui permette à l’utilisateur de supprimer une valeur d’un tableau préalablement saisi. L’utilisateur donnera l’indice de la valeur qu’il souhaite supprimer.
              <div style="display: flex; justify-content: center;">
