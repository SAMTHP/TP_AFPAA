...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison7/exo7_3/season7_exo_3.js"></script>
    </head>
  <body>
      <!-- NAVBAR -->
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 7.3</h5>
              <p class="card-text">Ecrivez un algorithme qui inverse l’ordre des éléments d’un tableau dont on suppose qu'il a été préalablement saisi (« les premiers seront les derniers… »).
              <div style="display: flex; justify-content: center;">
