...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison7/exo7_5/season7_exo_5.js"></script>
    </head>
  <body>
      <!-- NAVBAR -->
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 7.5</h5>
              <p class="card-text">Ecrivez l'algorithme qui recherche un mot saisi au clavier dans un dictionnaire.<br>
               Le dictionnaire est supposé être codé dans un tableau préalablement rempli et trié.  
              <div style="display: flex; justify-content: center;">
