      ...
      <!-- Affichage des résultats -->
        ...
        <div class="jumbotron " style="display: flex; justify-content: center;">
            <div class="card" id="card" style="width: 25rem;">
                ...
                <div class="card-body" >
                    <h5 class="card-title">Choisissez l'année pour voir le montant accumlé : </h5>
                    <form action="exo6_15_execution_view_final.php" method="POST">
                        <table class="table table-dark">
                            <tbody>
                                <tr>
                                    <th scope="row">Année : </th>
                                    <td><input type="number" class="form-control" id="year" name="year"></td>
                                    <input type="hidden" id="begin-money" name="begin-money" value="<?= $_POST["begin-money"] ?>">
                                </tr>
                                <tr>
                                    <th scope="row"><button type="submit" class="btn btn-primary " id="submit">Valider</button></th>
                                </tr>
                            </tbody>
                        </table>
