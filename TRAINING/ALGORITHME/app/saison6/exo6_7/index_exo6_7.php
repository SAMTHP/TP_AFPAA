...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison6/exo6_7/season6_exo_7.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 6.7</h5>
              <p class="card-text">Ecrivez la fin de l’algorithme 6.3 afin que le calcul de la moyenne des notes soit effectué et affiché à l’écran.  
              </p>
              <div style="display: flex; justify-content: center;">
