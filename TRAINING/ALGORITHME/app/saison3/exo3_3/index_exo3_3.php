...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison3/exo3_3/season3_exo_3.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 3.3</h5>
              <p class="card-text">Ecrire un algorithme qui demande trois noms à l’utilisateur et l’informe ensuite s’ils sont rangés ou non dans l’ordre alphabétique.</p>
              <div style="display: flex; justify-content: center;">
