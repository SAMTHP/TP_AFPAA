...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison3/exo3_2/season3_exo_2.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 3.2</h5>
              <p class="card-text">Ecrire un algorithme qui demande deux nombres à l’utilisateur et l’informe ensuite si leur produit est négatif ou positif (on laisse de côté le cas où le produit est nul). Attention toutefois : on ne doit pas calculer le produit des deux nombres.</p>
              <div style="display: flex; justify-content: center;">
