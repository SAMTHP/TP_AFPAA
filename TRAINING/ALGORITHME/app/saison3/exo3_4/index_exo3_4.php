...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison3/exo3_4/season3_exo_4.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 3.4</h5>
              <p class="card-text">Ecrire un algorithme qui demande un nombre à l’utilisateur, et l’informe ensuite si ce nombre est positif ou négatif (on inclut cette fois le traitement du cas où le nombre vaut zéro).</p>
              <div style="display: flex; justify-content: center;">
