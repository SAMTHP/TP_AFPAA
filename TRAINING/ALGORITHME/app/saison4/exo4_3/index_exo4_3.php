...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison4/exo4_3/season4_exo_3.js"></script>
  ...
  <body>
      ...
      <div style="display: flex; justify-content: center;">
        ...
        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">EXERCICES</button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="#">4.3</a>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 4.3</h5>
              <p class="card-text">De même que le précédent, cet algorithme doit demander une heure et en afficher une autre.<br>
              ...
              "Dans une seconde, il sera 21 heure(s), 32 minute(s) et 9 seconde(s)".</p>
              <div style="display: flex; justify-content: center;">
