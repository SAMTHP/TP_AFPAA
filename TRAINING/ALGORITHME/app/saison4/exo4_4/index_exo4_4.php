...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison4/exo4_4/season4_exo_4.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 4.4</h5>
              <p class="card-text">Un magasin de reprographie facture 0,10 € les dix premières photocopies, 0,09 € les vingt suivantes et 0,08 € au-delà.<br>
              Ecrivez un algorithme qui demande à l’utilisateur le nombre de photocopies effectuées et qui affiche la facture correspondante.</p>
              <div style="display: flex; justify-content: center;">
