...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison4/exo4_6/season4_exo_6.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 4.6</h5>
              <p class="card-text">Les élections législatives, en Toonerie Nationale, obéissent à la règle suivante :  <br>
                <ul>
                  <li>lorsque l'un des candidats obtient plus de 50% des suffrages, il est élu dès le premier tour. </li>
                  <li>en cas de deuxième tour, peuvent participer uniquement les candidats ayant obtenu au moins 12,5% des voix au premier tour.</li>
                </ul>
                Vous devez écrire un algorithme qui permette la saisie des scores de quatre candidats au premier tour.<br>
                Cet algorithme traitera ensuite le candidat numéro 1 (et uniquement lui) : <br>
                il dira s'il est élu, battu, s'il se trouve en ballottage favorable (il participe au second tour en étant arrivé en tête à l'issue du premier tour) ou défavorable (il participe au second tour sans avoir été en tête au premier tour). 
              </p>
              <div style="display: flex; justify-content: center;">
