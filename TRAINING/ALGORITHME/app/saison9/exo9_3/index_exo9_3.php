...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison9/exo9_3/season9_exo_3.js"></script>
  ...
  <body>
      ...
      <div style="display: flex; justify-content: center;">
        ...
        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">EXERCICES</button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#">9.3</a>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 9.3</h5>
              <p class="card-text">Ecrivez un algorithme qui demande une phrase à l’utilisateur et qui affiche à l’écran le nombre de mots de cette phrase. On suppose que les mots ne sont séparés que par des espaces.</p>
              <div style="display: flex; justify-content: center;">
