...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison9/exo9_5/season9_exo_5.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 9.5</h5>
              <p class="card-text">Ecrivez un algorithme qui demande une phrase à l’utilisateur.<br>
                Celui-ci entrera ensuite le rang d’un caractère à supprimer, et la nouvelle phrase doit être affichée (on doit réellement supprimer le caractère dans la variable qui stocke la phrase, et pas uniquement à l’écran).
              </p>
              <div style="display: flex; justify-content: center;">
