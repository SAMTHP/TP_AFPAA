...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison9/exo9_9/season9_exo_9.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 9.9</h5>
              <p class="card-text">Ecrire l’algorithme qui effectue un cryptage de Vigenère, en demandant bien sûr au départ la clé à l’utilisateur.
              </p>
              <div style="display: flex; justify-content: center;">
