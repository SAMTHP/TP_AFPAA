...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison5/exo5_7/season5_exo_7.js"></script>
  ...
  <body>
      ...
      <div style="display: flex; justify-content: center;">
        ...
        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">EXERCICES</button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#">5.7</a>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 5.7</h5>
              <p class="card-text">Ecrire un algorithme qui demande un nombre de départ, et qui calcule sa factorielle.</p>
              <div style="display: flex; justify-content: center;">
