...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison5/exo5_8/season5_exo_8.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 5.8</h5>
              <p class="card-text">Ecrire un algorithme qui demande successivement 20 nombres à l’utilisateur, et qui lui dise ensuite quel était le plus grand parmi ces 20 nombres.<br>
