...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison5/exo5_9/season5_exo_9.js"></script>
  ...
  <body>
      ...
      <div style="display: flex; justify-content: center;">
        ...
        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">EXERCICES</button>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="#">5.9</a>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 5.9</h5>
              <p class="card-text">Réécrire l’algorithme précédent, mais cette fois-ci on ne connaît pas d’avance combien l’utilisateur souhaite saisir de nombres.<br>
