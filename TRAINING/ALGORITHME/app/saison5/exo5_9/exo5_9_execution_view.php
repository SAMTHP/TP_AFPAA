        ...
        <div class="jumbotron " style="display: flex; justify-content: center;">
            <div class="card" id="card" style="width: 25rem;">
                ...
                <div class="card-body" >
                    ...
                    <p class="card-text">
                        <?php require_once "exo5_9_execution.php" ?>
                    </p>
                    <br>
                    <?php if($flag): ?>
                        <form action="#" method="POST">
                            <div class="form-group">
                                <div class="row">
                                    <p>&nbsp&nbsp&nbsp</p>
                                    <label for="choice" >Choisissez un nouveau nombre: </label>
                                    <div>
                                        <p>&nbsp</p>
                                    </div>
                                    <input type="number" class="form-control col-3" id="choice" name="choice" >
                                </div>
