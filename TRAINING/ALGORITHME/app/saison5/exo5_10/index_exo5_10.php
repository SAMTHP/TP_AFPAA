...
<html lang="fr">
  <head>
      ...
      <script type="text/javascript" src="../../js/saison5/exo5_10/season5_exo_10.js"></script>
  ...
  <body>
      ...
      <div class="jumbotron " style="display: flex; justify-content: center;">
        <div class="card" id="card" style="width: 25rem;">
          ...
          <div class="card-body" >
              <h5 class="card-title">Exercice 5.10</h5>
              <p class="card-text">Lire la suite des prix (en euros entiers et terminée par zéro) des achats d’un client.<br>
