...
jQuery(document).ready(function($){
	...
	$(".cost-slider").each(function(){
		$(this).slider({
			...
			slide: function(event, ui){
				...
				$("#painting-cost").costCalculator("calculate");
				$("#floor-tile-cost").costCalculator("calculate");
				$("#parquet-cost").costCalculator("calculate");
				$("#placo-cost").costCalculator("calculate");
				$("#terraces-cost").costCalculator("calculate");
				$("#facades-cost").costCalculator("calculate");
			},
	...
	$("#painting-cost").costCalculator({
		formula: "ir-square-feet*ir-coating+ir-square-feet*ir-preparation+ir-square-feet*ir-white+ir-square-feet*ir-color",
		currency: "€",
		updateHidden: $("#pt-total-cost")
	});
	$("#floor-tile-cost").costCalculator({
		formula: "ft-square-feet*ft-cope+ft-square-feet*ft-glued-pose+ft-square-feet*ft-swimming-pool",
		currency: "€",
		updateHidden: $("#ft-total-cost")
	});
	$("#parquet-cost").costCalculator({
		formula: "pq-square-feet*parquet-float-laminate+pq-square-feet*parquet-wood",
		currency: "€",
		updateHidden: $("#parquet-total-cost")
	});
	$("#placo-cost").costCalculator({
		formula: "pl-square-feet*placo-glued+pl-square-feet*placo-still+pl-square-feet*placo-isolate",
		currency: "€",
		updateHidden: $("#placo-total-cost")
	});
	$("#terraces-cost").costCalculator({
		formula: "tr-square-feet*tr-wood+tr-square-feet*tr-floor-tile",
		currency: "€",
		updateHidden: $("#tr-total-cost")
	});
	$("#facades-cost").costCalculator({
		formula: "fc-square-feet*fc-monolayer+fc-square-feet*fc-drunk",
		currency: "€",
		updateHidden: $("#facades-total-cost")
	});
