<nav>
	<ul class="sf-menu">
		...
		<li<?php echo ($_GET["page"]=="about" || $_GET["page"]=="404" || $_GET["page"]=="services" || $_GET["page"]=="services2" || $_GET["page"]=="projects" || $_GET["page"]=="team" || $_GET["page"]=="team_mark_whilberg" ? " class='selected'" : ""); ?>>
			...
			<ul>
				...
				<li<?php echo ($_GET["page"]=="projects" ? " class='selected'" : ""); ?>>
					<a href="?page=projects" title="Projects">
						Projects
					</a>
				</li>
