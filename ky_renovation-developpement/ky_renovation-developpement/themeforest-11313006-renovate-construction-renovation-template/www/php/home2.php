		...
		<ul style="display: none;">
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				...
				<div class="tp-caption"
					...
					<div class="slider-content-box">
						<h2><a href="?page=service_tiling_painting" title="TILING AND PAINTING">PROFESSIONAL TILING AND PAINTING SERVICES</a></h2>
	...
	<div class="clearfix">
		...
		<div class="row full-width gray flex-box page-margin-top-section">
			...
			<div class="column column-1-3 background-1">
				<img class="flex-hide" src="images/samples/750x500/image_07.jpg" alt="">
			</div>
			<div class="column column-1-3 padding-left-right-100 padding-bottom-50">
		...
		<div class="row page-margin-top-section">
			...
			<div class="carousel-container page-margin-top clearfix">
				<ul class="blog horizontal-carousel three-columns autoplay-0 pause_on_hover-1">
					<li class="column column-1-3">
						...
						<h4><a href="?page=post">WHAT A DIFFERENCE A FEW MONTHS MAKE</a></h4>
					...
					<li class="column column-1-3">
						...
						<h4><a href="?page=post">KITCHEN AND LIVING ROOM RENOVATION</a></h4>
						<p class="description t1">Paetos dignissim at cursus elefeind norma arcu. Pellentesque mode accumsan est in tempus, etos at ullamcorper quam suscipit lacus maecenas tortor.</p>
					</li>
					<li class="column column-1-3">
						<a href="?page=post" title="Signs You Need Drain Repair Services" class="post-image">
						...
						<h4><a href="?page=post">SIGNS YOU NEED DRAIN REPAIR SERVICES</a></h4>
						<p class="description t1">Paetos dignissim at cursus elefeind norma arcu. Pellentesque mode accumsan est in tempus, etos at ullamcorper quam suscipit lacus maecenas tortor.</p>
					</li>
					<li class="column column-1-3">
						<a href="?page=post" title="Steps To Improve Joint Placement" class="post-image">
						...
						<h4><a href="?page=post">STEPS TO IMPROVE JOINT PLACEMENT</a></h4>
						<p class="description t1">Paetos dignissim at cursus elefeind norma arcu. Pellentesque mode accumsan est in tempus, etos at ullamcorper quam suscipit lacus maecenas tortor.</p>
					</li>
					<li class="column column-1-3">
						<ul class="post-details">
						...
						<h4><a href="?page=post">HOW TO CHOOSE A RELIABLE COMPANY</a></h4>
						<p class="description t1">Paetos dignissim at cursus elefeind norma arcu. Pellentesque mode accumsan est in tempus, etos at ullamcorper quam suscipit lacus maecenas tortor.</p>
					</li>
					<li class="column column-1-3">
						<a href="?page=post" title="Installation Of Click Laminate Flooring" class="post-image">
						...
						<h4><a href="?page=post">INSTALLATION OF CLICK LAMINATE FLOORING</a></h4>
						<p class="description t1">Paetos dignissim at cursus elefeind norma arcu. Pellentesque mode accumsan est in tempus, etos at ullamcorper quam suscipit lacus maecenas tortor.</p>
					</li>
					<li class="column column-1-3">
						<a href="?page=post" title="What a Difference a Few Months Make" class="post-image">
			...
			<div class="align-center padding-top-54 padding-bottom-17">
				<a class="more" href="?page=blog_3_columns" title="VIEW ALL POSTS">VIEW ALL POSTS</a>
			</div>
		</div>
			...
			<div class="row">
				...
				<ul class="services-list services-icons row clearfix page-margin-top">
					...
					<li>
						...
						<div class="service-content">
							<h4 class="box-header"><a href="?page=service_household_repairs" title="Household Repairs">HOUSEHOLD REPAIRS</a></h4>
				...
				<ul class="services-list services-icons row clearfix margin-top-30">
					<li>
						...
						<div class="service-content">
							<h4 class="box-header"><a href="?page=service_paver_walkways" title="Paver Walkways">PAVER WALKWAYS</a></h4>
							<p>Brick pavers define beauty, elegance and durability for driveways, patios and walkways.</p>
						</div>
					</li>
					<li>
						<a href="?page=service_tiling_painting" title="Tiling and Painting"><span class="service-icon sl-small-bucket"></span></a>
						<div class="service-content">
